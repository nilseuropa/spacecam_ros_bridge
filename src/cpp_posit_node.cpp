...
int main(int argc, char **argv)
{
  ...
  model.objectPts[0][0] = 0.0f;
  model.objectPts[0][1] = 0.0f;
  model.objectPts[0][2] = 0.0f;

  model.objectPts[1][0] = 0.25f;
  model.objectPts[1][1] = 0.0f;
  model.objectPts[1][2] = 0.0f;

  model.objectPts[2][0] = 0.0f;
  model.objectPts[2][1] = 0.0f;
  model.objectPts[2][2] = 0.75f;

  model.objectPts[3][0] = 0.0f;
  model.objectPts[3][1] = 0.5f;
  model.objectPts[3][2] = 0.0f;

  model.objectMatrix[0][0] = 0.0f;
  model.objectMatrix[0][1] = 1.0f/0.25f;
  model.objectMatrix[0][2] = 0.0f;
  model.objectMatrix[0][3] = 0.0f;

  model.objectMatrix[1][0] = 0.0f;
  model.objectMatrix[1][1] = 0.0f;
  model.objectMatrix[1][2] = 1.0f/0.75f;
  model.objectMatrix[1][3] = 0.0f;

  model.objectMatrix[2][0] = 0.0f;
  model.objectMatrix[2][1] = 0.0f;
  model.objectMatrix[2][2] = 0.0f;
  model.objectMatrix[2][3] = 1.0f/0.5f;
  ...
  while (ros::ok()) {
    ...
    if (new_trackpoints_available){
      posit.estimate(model, image, &pose);
